...
ax.text(datetime.datetime(2021, 1 , 28,0,0,0)-datetime.timedelta(days = 0.5),1300000,
...
ax.text(datetime.datetime(2021, 1 , 28,0,0,0)-datetime.timedelta(days = 0.5),6800000,
...
ax.text(datetime.datetime(2021, 2 , 3,0,0,0)-datetime.timedelta(days = 0.5),9000000,
        "Over 75s", fontsize=20)

ax.plot(date_list, np.full(date_list.shape,13400000),label='_nolegend_',lw=width,c='black')
ax.text(datetime.datetime(2021, 1 , 28,0,0,0)-datetime.timedelta(days = 0.5),13700000,
