...
if __name__ == "__main__":
    ...
    ax.text(datetime.datetime(2021, 2 , 7,0,0,0)+datetime.timedelta(days = 0.2),target_2mpd*0.99,"2million/week", fontdict={'size':20})

    ax.plot(date_list, target_3m,label='_nolegend_')
    ax.text(datetime.datetime(2021, 2 , 7,0,0,0)+datetime.timedelta(days = 0.2),target_3mpd*0.99,"3million/week", fontdict={'size':20})

    ax.plot(date_list, target_4m, c='purple',label='_nolegend_')
    ax.text(datetime.datetime(2021, 2 , 7,0,0,0)+datetime.timedelta(days = 0.2),target_4mpd*0.99,"4million/week", fontdict={'size':20})
    ...
    ax.plot(by_date["date_real"],by_date["7day_avg"],c="springgreen", lw=3, marker='X')
